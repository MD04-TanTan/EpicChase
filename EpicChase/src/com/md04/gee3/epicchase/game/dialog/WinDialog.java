...
public class WinDialog extends Dialog {
	...
	public WinDialog(int level, int w, int h, Listener listener) {
		super(3, w, h, listener);
		bg = loadImage("win.png");
		this.level = level;
		setItem(REPLAY, new MenuItem(loadSprite("replay_footer.png", 2)));
		setItem(CONTINUE, new MenuItem(loadSprite("back_footer.png", 2)));
	...
	protected void paint(Graphics g) {
        ...
        g.setFont(fontBold);
        g.drawString("LEVEL " + level + " COMPLETED!", width/2, height/2 - 10, 
